var equalise_floatlength = require("../akd_bigint.js");
...
//     it("two small floats..", ()=>{
//         expect(mult("10.01","10.01")).toBe("100.2001");
//     });

//     it("1.3 sqr..", ()=>{
//         expect(mult("1.3","1.3")).toBe("1.69");
//     });

//     it("10.909 sqr..", ()=>{
//         expect(mult("10.909","10.909")).toBe("119.006281");
//     });

//     it("100.003 sqr..", ()=>{
//         expect(mult("100.003","100.003")).toBe("10000.600009");
//     });

//     it("1234.5678 x 5678.4321", ()=>{
//         expect(mult("1234.5678","5678.4321")).toBe("7010409.42514638");
//     });
...
describe("EQUALISE",()=>{
    ...
    it("23.4544 - 4.56", ()=>{
        expect(equalise_floatlength({original:"23.4544",pow:2,value:"234544"},{pow:1,original:"4.56",value:"456"})).toBe(["234544","045600"]);
    });
